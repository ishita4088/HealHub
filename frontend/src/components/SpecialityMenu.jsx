...
function SpecialityMenu() {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      <h1 className='text-3xl font-medium'>Explore Specialists</h1>
      <p className='sm:w-1/3 text-center text-sm' >Find the right expert and schedule your appointment effortlessly!</p>
